import type { ChangedFile, PullRequestContext, ReviewAnnotation, ReviewResult, ReviewedRange, Severity } from '../types/review.js';
 ...
 */
export declare function validateAndRankFindings(findings: ReviewAnnotation[], changedFiles: ChangedFile[], config: ReviewConfig, options?: {
    capAnnotations?: boolean;
}): ReviewAnnotation[];

 ...
 */
export declare function createIncrementalReview(octokit: FiscalcrOctokit, params: {
    owner: string;
    repo: string;
    pullNumber: number;
    commitSha: string;
 ...
 */
export declare function dismissBlockingReview(octokit: FiscalcrOctokit, params: {
    owner: string;
    repo: string;
    pullNumber: number;
    reviewId: number;
 ...
 */
export declare function createThreadResolutionComment(octokit: FiscalcrOctokit, params: {
    owner: string;
    repo: string;
    pullNumber: number;
    headSha: string;
 ...
 */
export declare function createPRReview(octokit: FiscalcrOctokit, params: {
    owner: string;
    repo: string;
    pullNumber: number;
    commitSha: string;

...
export declare function extractPullRequestContext(octokit: FiscalcrOctokit, owner: string, repo: string, pullNumber: number, config: ReviewConfig, options?: ExtractOptions): Promise<PullRequestContext>;
